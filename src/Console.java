...
//                    System.out.println(interactions);
                ...
                case "6":
                    ...
                    while (!potential.matches("^[A-Za-z\\s]{1,}[\\.]{0,1}[A-Za-z\\s]{0,}$") || !potential.equalsIgnoreCase("Potential") || !potential.equalsIgnoreCase("Negative") || !potential.equalsIgnoreCase("Neutral")) {
                        System.out.println("Please enter a valid mean: ");
                        potential = sc.nextLine();
                    }
                    if (potential.equalsIgnoreCase("Potential") || potential.equalsIgnoreCase("Negative") || potential.equalsIgnoreCase("Neutral") && potential.matches("^[A-Za-z\\s]{1,}[\\.]{0,1}[A-Za-z\\s]{0,}$")) {
